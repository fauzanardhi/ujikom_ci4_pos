    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <?php
                echo anchor('admin/laporan/generatepdf', '<button style="background: linear-gradient(25deg, rgba(57, 143, 255, 1) 0%, rgba(130, 184, 255, 1 ) 100% );"  type="button" class="btn-sm btn-light text-light p-2">
                ...
                foreach ($transaksi as $item) :
                    $table->addRow($item->tgl_transaksi, $item->nama_pelanggan, $item->nama_produk,
                    $item->harga, $item->jumlah_produk, $item->total_harga);
                endforeach;
